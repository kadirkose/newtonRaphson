...
# ACDS 20.1 720 linux 2022.02.02.16:30:56
# ----------------------------------------
...
# ----------------------------------------
# If fp_pow is one of several IP cores in your
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/kadirkose/intelFPGA_lite/20.1/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC2_uid263_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC1_uid258_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC1_uid451_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC2_uid454_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC2_uid262_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC0_uid447_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC3_uid457_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC0_uid255_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC1_uid259_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC0_uid254_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_pow_memoryC3_uid266_lnTables_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_pow.vhd"               
}
