...
TOP_LEVEL_NAME="fp_pow"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/kadirkose/intelFPGA_lite/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fp_pow_memoryC2_uid263_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC1_uid258_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC1_uid451_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC2_uid454_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC2_uid262_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC0_uid447_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC3_uid457_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC0_uid255_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC1_uid259_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC0_uid254_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_pow_memoryC3_uid266_lnTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_pow.vhd"               
fi
