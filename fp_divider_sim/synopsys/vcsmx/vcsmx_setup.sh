...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fp_divider_memoryC1_uid150_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_divider_memoryC0_uid146_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_divider_memoryC1_uid151_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_divider_memoryC0_uid147_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_divider_memoryC2_uid154_invTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_divider.vhd"           
fi
