...
# ACDS 20.1 720 linux 2022.02.02.16:31:29
# ----------------------------------------
...
# ----------------------------------------
# If fp_divider is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fp_divider_memoryC1_uid150_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_divider_memoryC0_uid146_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_divider_memoryC1_uid151_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_divider_memoryC0_uid147_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_divider_memoryC2_uid154_invTables_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_divider.vhd"           
}
